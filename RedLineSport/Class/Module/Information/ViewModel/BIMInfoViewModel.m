...
@implementation BIMInfoViewModel
- (void)fetchRecommendedReviewsWithParameter:(NSDictionary *)param
                                    callBack:(requestCallBack)response {
    [[BIMDCHttpRequest shareInstance]sendGetRequestByMethod:@"get" WithParamaters:param PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,info_url] Start:^(id requestOrignal) {
