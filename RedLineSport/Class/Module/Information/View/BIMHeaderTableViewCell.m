...
@interface BIMHeaderTableViewCell ()
@property (nonatomic , strong) CALayer *lineLayer;
@property (nonatomic, strong) UIImageView *iconImageView;
@property (nonatomic, strong) UILabel *titleLabel;
@end
@implementation BIMHeaderTableViewCell
...
+ (BIMHeaderTableViewCell *)cellForTableView:(UITableView *)tableView {
    BIMHeaderTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
        cell = [[BIMHeaderTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
