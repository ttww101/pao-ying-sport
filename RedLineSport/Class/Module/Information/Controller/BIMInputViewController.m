...
@interface BIMInputViewController () <UITextViewDelegate>
...
@implementation BIMInputViewController
- (void)viewDidLoad {
    [super viewDidLoad];
     [self configUI];
}
...
- (void)upContent {
    ...
    [[BIMDCHttpRequest shareInstance]sendRequestByMethod:@"post" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,info_like_comment] ArrayFile:nil Start:^(id requestOrignal) {
