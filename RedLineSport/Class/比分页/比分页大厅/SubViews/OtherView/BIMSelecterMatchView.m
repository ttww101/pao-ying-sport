...
@interface BIMSelecterMatchView()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate,UIGestureRecognizerDelegate>
@end
@implementation BIMSelecterMatchView
...
{
    if (_delegate && [_delegate respondsToSelector:@selector(BIMSelecterMatchView:selectedAtIndex:)]) {
        [_delegate BIMSelecterMatchView:self selectedAtIndex:indexPath.row];
    }
}
@end
