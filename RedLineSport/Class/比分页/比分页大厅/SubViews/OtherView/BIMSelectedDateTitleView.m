...
@interface BIMSelectedDateTitleView()
...
@end
@implementation BIMSelectedDateTitleView
...
- (void)didAction {
    if (_delegate && [_delegate respondsToSelector:@selector(BIMSelectedDateTitleViewDidAction:)]) {
        [_delegate BIMSelectedDateTitleViewDidAction:self.arrData];
    }
}
