...
@interface BIMBifenSetingViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@end
@implementation BIMBifenSetingViewController
        ...
        case 2:
        {
            switch (indexPath.row) {
                ...
                case 1:
                    ...
                    [lab setAttributedText:[BIMMethods withContent:@"编号(竞彩、北单、足彩)" WithColorText:@"(竞彩、北单、足彩)" textColor:grayColor3 strFont:font11]];
