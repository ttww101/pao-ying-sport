...
@interface BIMRecommendedWKWeb () <UIWebViewDelegate, WKUIDelegate, WKNavigationDelegate>
@property (nonatomic , copy) GQJSResponseCallback callBack;
@property (nonatomic, strong) UIProgressView *progressView;
@property (nonatomic , strong) WebViewJavascriptBridge* bridge;
@end
@implementation BIMRecommendedWKWeb
...
- (void)loadBradgeHandler {
    __weak BIMRecommendedWKWeb *weakSelf = self;
