...
@interface BIMNewZhiShuWebVC ()
@property (nonatomic, strong)UIWebView *webView;
@property WebViewJavascriptBridge* bridge;
@property (nonatomic, retain)NSMutableArray *arrData;
@end
@implementation BIMNewZhiShuWebVC
...
- (UIWebView *)webView{
    if (!_webView) {
        ...
        [_bridge registerHandler:@"tongpeiList" handler:^(id data, WVJBResponseCallback responseCallback) {
            ...
            BIMTongPeiDetailVC *listWeb = [[BIMTongPeiDetailVC alloc] init];
...
-(void)loadData{
    ...
    [[BIMDCHttpRequest shareInstance] sendHtmlGetRequestByMethod:@"get" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url_OddsList] Start:^(id requestOrignal) {
