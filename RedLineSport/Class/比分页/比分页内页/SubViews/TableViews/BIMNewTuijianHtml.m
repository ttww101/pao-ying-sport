...
@end
@implementation BIMNewTuijianHtml
...
- (void)loadZhiShu{
    ...
    [[BIMDCHttpRequest shareInstance] sendHtmlGetRequestByMethod:@"get" WithParamaters:dict PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,_indexZhiShuNum == 3 ? url_JiaoYiList:url_ZhiShuOuPei] Start:^(id requestOrignal) {
