...
@implementation BIMInfoListModel
...
{
    return [MTLValueTransformer reversibleTransformerWithBlock:^id(NSNumber *number) {
        return [BIMMethods getDateByStyle:dateStyleFormatter withDate:[NSDate dateWithTimeIntervalSince1970:[number doubleValue]/1000]];
    }];
}
