...
@end
@implementation BIMJSPLDownCell
- (void)awakeFromNib {
    [super awakeFromNib];
}
...
- (void)setJsplDwonModel:(BIMJSPLDownMode *)jsplDwonModel
{
...
- (void)setJsplDwonTwoModel:(BIMJSPLDownTwoModel *)jsplDwonTwoModel {
