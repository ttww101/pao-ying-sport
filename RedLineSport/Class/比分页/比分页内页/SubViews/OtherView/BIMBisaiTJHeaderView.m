...
#import "BIMBisaiTJRoundView.h"
#import "BIMBisaiTHeaderFenxiView.h"
#import "BIMTechtwoModel.h"
@interface BIMBisaiTJHeaderView()
@end
@implementation BIMBisaiTJHeaderView
...
{
    _arrdata = arrdata;
    BIMTechtwoModel *home;
    BIMTechtwoModel *guest;
    if (_arrdata.count == 2) {
    ...
    for (int i = 0; i<3; i++) {
        ...
        BIMBisaiTJRoundView *round = [[BIMBisaiTJRoundView alloc] initWithFrame:CGRectMake(0, 40, 40, 40)];
    ...
    if (isOniphone6p) {
        BIMBisaiTHeaderFenxiView *headerLeft = [[BIMBisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(20, 90 + 10, 30*4, 25*2)];
        headerLeft.ishome = 0;
        headerLeft.model = home;
        [self addSubview:headerLeft];
        BIMBisaiTHeaderFenxiView *headerRight = [[BIMBisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(Width - 20 - 30*4, 90 + 10, 30*4, 25*2)];
        headerRight.ishome = 1;
        headerRight.model = guest;
        [self addSubview:headerRight];
    }else if (isOniPhone4 || isOniPhone5){
        BIMBisaiTHeaderFenxiView *headerLeft = [[BIMBisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(10, 90 + 10, 25*4, 25*2)];
        headerLeft.ishome = 0;
        headerLeft.model = home;
        [self addSubview:headerLeft];
        BIMBisaiTHeaderFenxiView *headerRight = [[BIMBisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(Width - 10 - 25*4, 90 + 10, 25*4, 25*2)];
        headerRight.ishome = 1;
        headerRight.model = guest;
        [self addSubview:headerRight];
    }else{
        BIMBisaiTHeaderFenxiView *headerLeft = [[BIMBisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(10, 90 + 10, 30*4, 25*2)];
        headerLeft.ishome = 0;
        headerLeft.model = home;
        [self addSubview:headerLeft];
        BIMBisaiTHeaderFenxiView *headerRight = [[BIMBisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(Width - 10 - 30*4, 90 + 10, 30*4, 25*2)];
        headerRight.ishome = 1;
        headerRight.model = guest;
        [self addSubview:headerRight];
    }
