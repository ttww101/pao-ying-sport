...
@interface BIMPeiLvDetailVC ()<HSTabBarContentViewDelegate,HSTabBarContentViewDataSource>
...
@end
@implementation BIMPeiLvDetailVC
...
- (UIView *)tabBarContentView:(BIMHSTabBarContentView *)tabBarContentView contentViewAtIndex:(NSInteger)index {
    if (self.PeiLvCType == isBeforeTwo) {
        BIMPeiLvDetailTableVC  *peilvTableVC = [BIMPeiLvDetailTableVC new];
