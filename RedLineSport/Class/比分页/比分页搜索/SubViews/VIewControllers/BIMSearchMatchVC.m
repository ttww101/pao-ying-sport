...
@interface BIMSearchMatchVC ()<UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate>
@property (nonatomic, strong) UISearchBar *searchBar;
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSMutableArray *arrData;
@end
@implementation BIMSearchMatchVC
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        [_tableView registerClass:[BIMSaiTableViewCell class] forCellReuseIdentifier:cellSearchMatchVC];
...
{
    BIMSaiTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellSearchMatchVC];
    if (!cell) {
        cell = [[BIMSaiTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellSearchMatchVC];
    }
