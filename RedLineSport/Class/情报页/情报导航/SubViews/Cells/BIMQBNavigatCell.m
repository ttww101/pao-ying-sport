...
@end
@implementation BIMQBNavigatCell
...
- (void)setModel:(BIMNavigationModel *)model{
    _model = model;
    ...
    self.labLeague.textColor = [BIMMethods getColor:model.leagueColor];
    self.labTime.text = [NSString stringWithFormat:@"%@",[BIMMethods getDateByStyle:dateStyleFormatterMdHm withDate:[NSDate dateWithTimeIntervalSince1970:[model.matchtime doubleValue]/1000]]];
