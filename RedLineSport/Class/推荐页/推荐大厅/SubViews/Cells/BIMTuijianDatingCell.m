...
#import "BIMTeamViewofTuijianCell.h"
#import "BIMBuyViewofTuijianView.h"
#import "BIMPeilvViewOfTuijianCell.h"
#import "BIMUserViewofMyBuyTuijian.h"
@interface BIMTuijianDatingCell()
@property (nonatomic, assign) BOOL didSetupConstraints;
@property (nonatomic, strong) UIView *basicView;
@property (nonatomic, strong) BIMUserViewOfTuijianCellCopy *headerUser;
@property (nonatomic, strong) BIMUserViewofMyBuyTuijian *UserofMyBuy;
@property (nonatomic, strong) BIMTeamViewofTuijianCell *teamView;
@property (nonatomic, strong) BIMBuyViewofTuijianView *buymView;
@property (nonatomic, strong) BIMPeilvViewOfTuijianCell *peilvView;
...
@end
@implementation BIMTuijianDatingCell
- (void)awakeFromNib {
    [super awakeFromNib];
}
...
- (void)setModel:(BIMTuijiandatingModel *)model
{
    ...
    if (_type == typeTuijianCellMybuy) {
        ...
        _labConmmentNum.text = [BIMMethods compareCurrentTime:_model.recommendTime];
...
- (BIMUserViewofMyBuyTuijian *)UserofMyBuy
{
    if (!_UserofMyBuy) {
        _UserofMyBuy = [[BIMUserViewofMyBuyTuijian alloc] init];
    }
    return _UserofMyBuy;
}
- (BIMTeamViewofTuijianCell *)teamView
{
    if (!_teamView) {
        _teamView = [[BIMTeamViewofTuijianCell alloc] init];
    }
    return _teamView;
}
- (BIMBuyViewofTuijianView *)buymView
{
    if (!_buymView) {
        _buymView = [[BIMBuyViewofTuijianView alloc] init];
    }
    return _buymView;
}
- (BIMPeilvViewOfTuijianCell *)peilvView
{
    if (!_peilvView) {
        _peilvView = [[BIMPeilvViewOfTuijianCell alloc] init];
    }
    return _peilvView;
}
- (UILabel *)labMoney
...
//                make.size.mas_equalTo(CGSizeMake(54, 25));
            ...
            [self.goldLabel mas_makeConstraints:^(MASConstraintMaker *make) {
                ...
                make.left.equalTo(self.lockIV.mas_right).offset(3);
...
- (void)toTuijianDetail
{
    if (_type == typeTuijianCellMybuy) {
        if (_model.otype == 1) {
            ...
            [[BIMMethods help_getCurrentVC].navigationController pushViewController:infoVC animated:true];
        }
    }else{
