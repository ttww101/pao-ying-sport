...
@interface BIMTeamViewofTuijianCell ()
...
@end
@implementation BIMTeamViewofTuijianCell
- (id)init
{
    self = [super init];
    if (self) {
...
- (void)setModel:(BIMTuijiandatingModel *)model
{
    ...
    NSInteger timeI =  [BIMMethods formatTimeStr:_model.MatchTime];
    _labbeginTime.text = [BIMMethods formatMMDDWithStamp:timeI / 1000];
    ...
    if (_model.MatchState == -1) {
        ...
        _labVS.text = [BIMMethods getTextByMatchState:_model.MatchState];
    }
    ...
    if (_model.amount == 0) {
        ...
        _labMoney.attributedText = [BIMMethods withContent:_labMoney.text WithColorText:str textColor:color33 strFont:font12];
    }
    _labMoney.text = @"";
    if (!_isaddlayout) {
        _isaddlayout = YES;
