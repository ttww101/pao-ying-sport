...
@interface BIMTuijianSelectedItemView()<UIGestureRecognizerDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,TuijianSelectedItemTitleViewDelegate>
...
@end
@implementation BIMTuijianSelectedItemView
