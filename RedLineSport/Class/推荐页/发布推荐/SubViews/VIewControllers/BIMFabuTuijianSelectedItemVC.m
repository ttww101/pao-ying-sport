...
@interface BIMFabuTuijianSelectedItemVC ()<ViewPagerDataSource,ViewPagerDelegate,TitleIndexViewDelegate>
@property (nonatomic, assign)NSInteger currentIndex;
@property (nonatomic, strong)BIMTitleIndexView *titleView;
@end
@implementation BIMFabuTuijianSelectedItemVC
...
- (UIViewController *)viewPager:(BIMViewPagerController *)viewPager contentViewControllerForTabAtIndex:(NSUInteger)index
{
    switch (index) {
        case 0:
        {
            BIMDan_StringGuanVC *fabuTuijianVC = [[BIMDan_StringGuanVC alloc] init];
