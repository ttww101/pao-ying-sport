...
#import "BIMSelectedViewOfFabuTuijian.h"
#import "BIMZhumaViewOfFabuTuijian.h"
#import "BIMRelRecNewVC.h"
...
@interface BIMRelRecNewVC ()<UITextViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,SelectedViewOfFabuTuijianDelegate,ZhumaViewOfFabuTuijianDelegate,TitleIndexViewDelegate, UITextFieldDelegate>
@property (nonatomic, strong) UITextView *textView;
@property (nonatomic, strong) UITextField *textFiled;
@property (nonatomic, strong) BIMNavView *nav;
...
@property (nonatomic, strong) BIMZhumaViewOfFabuTuijian *viewZhuma;
...
@property (nonatomic , strong) BIMUserModel *user_Model;
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [[BIMUMStatisticsMgr sharedInstance] viewStaticsBeginWithMarkStr:@"BIMRelRecNewVC"] ;
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    [[BIMUMStatisticsMgr sharedInstance] viewStaticsEndWithMarkStr:@"BIMRelRecNewVC"];
}
- (void)setupModel:(BIMDan_StringMatchsModel *)model{
    _model = model;
    ...
    if (model.spf.count > 0) {
        BIMDxModel *dxModel = model.spf[0];
        ...
        [self.btnOne setAttributedTitle:[BIMMethods withContent:self.btnOne.titleLabel.text WithContColor:UIColorHex(#151515) WithContentFont:font12 WithText:@"胜" WithTextColor:UIColorHex(#151515) WithTextFont:font12] forState:UIControlStateNormal];
        [self.btnOne setAttributedTitle:[BIMMethods withContent:self.btnOne.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font12 WithText:self.btnOne.titleLabel.text WithTextColor:[UIColor whiteColor] WithTextFont:font12] forState:UIControlStateSelected];
        [self.btnTwo setTitle:[NSString stringWithFormat:@"平        %.2f",[dxModel.Goal floatValue]] forState:UIControlStateNormal];
        [self.btnTwo setAttributedTitle:[BIMMethods withContent:self.btnTwo.titleLabel.text WithContColor:UIColorHex(#151515) WithContentFont:font12 WithText:@"平" WithTextColor:UIColorHex(#151515) WithTextFont:font12] forState:UIControlStateNormal];
        [self.btnTwo setAttributedTitle:[BIMMethods withContent:self.btnTwo.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font12 WithText:self.btnTwo.titleLabel.text WithTextColor:[UIColor whiteColor] WithTextFont:font12] forState:UIControlStateSelected];
        [self.btnThree setTitle:[NSString stringWithFormat:@"负        %.2f",[dxModel.DownOdds floatValue]] forState:UIControlStateNormal];
        [self.btnThree setAttributedTitle:[BIMMethods withContent:self.btnThree.titleLabel.text WithContColor:UIColorHex(#151515) WithContentFont:font12 WithText:@"负" WithTextColor:UIColorHex(#151515) WithTextFont:font12] forState:UIControlStateNormal];
        [self.btnThree setAttributedTitle:[BIMMethods withContent:self.btnThree.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font12 WithText:self.btnThree.titleLabel.text WithTextColor:[UIColor whiteColor] WithTextFont:font12] forState:UIControlStateSelected];
    }
    
    if (model.rq.count > 0) {
        BIMDxModel *dxModel = model.rq[0];
        self.oddsLab.text = dxModel.company;
        [self.btnZhu setTitle:[NSString stringWithFormat:@"主        %.2f",[dxModel.UpOdds floatValue]] forState:UIControlStateNormal];
        [self.btnZhu setAttributedTitle:[BIMMethods withContent:self.btnZhu.titleLabel.text WithContColor:UIColorHex(#151515) WithContentFont:font12 WithText:@"主" WithTextColor:UIColorHex(#151515) WithTextFont:font12] forState:UIControlStateNormal];
        [self.btnZhu setAttributedTitle:[BIMMethods withContent:self.btnZhu.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font12 WithText:self.btnZhu.titleLabel.text WithTextColor:[UIColor whiteColor] WithTextFont:font12] forState:UIControlStateSelected];
        
        
        [self.yaCenterBtn setTitle:[NSString stringWithFormat:@"%@",dxModel.Goal] forState:UIControlStateNormal];
        [self.yaCenterBtn setAttributedTitle:[BIMMethods withContent:self.yaCenterBtn.titleLabel.text WithContColor:UIColorHex(#151515) WithContentFont:font12 WithText:@"" WithTextColor:UIColorHex(#151515) WithTextFont:font12] forState:UIControlStateNormal];
        [self.yaCenterBtn setAttributedTitle:[BIMMethods withContent:self.yaCenterBtn.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font12 WithText:self.yaCenterBtn.titleLabel.text WithTextColor:[UIColor whiteColor] WithTextFont:font12] forState:UIControlStateSelected];
        [self.btnKe setTitle:[NSString stringWithFormat:@"客        %.2f",[dxModel.DownOdds floatValue]] forState:UIControlStateNormal];
        [self.btnKe setAttributedTitle:[BIMMethods withContent:self.btnKe.titleLabel.text WithContColor:UIColorHex(#151515) WithContentFont:font12 WithText:@"客" WithTextColor:UIColorHex(#151515) WithTextFont:font12] forState:UIControlStateNormal];
        [self.btnKe setAttributedTitle:[BIMMethods withContent:self.btnKe.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font12 WithText:self.btnKe.titleLabel.text WithTextColor:[UIColor whiteColor] WithTextFont:font12] forState:UIControlStateSelected];
    }
    
    if (model.dx.count > 0) {
        BIMDxModel *dxModel = model.dx[0];
        self.oddsLab.text = dxModel.company;
        [self.btnBig setTitle:[NSString stringWithFormat:@"大        %.2f", [dxModel.UpOdds floatValue]] forState:UIControlStateNormal];
        [self.btnBig setAttributedTitle:[BIMMethods withContent:self.btnBig.titleLabel.text WithContColor:UIColorHex(#151515) WithContentFont:font12 WithText:@"大" WithTextColor:UIColorHex(#151515) WithTextFont:font12] forState:UIControlStateNormal];
        [self.btnBig setAttributedTitle:[BIMMethods withContent:self.btnBig.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font12 WithText:self.btnBig.titleLabel.text WithTextColor:[UIColor whiteColor] WithTextFont:font12] forState:UIControlStateSelected];
        
        
        
        [self.dxCenterBtn setTitle:[NSString stringWithFormat:@"%@",dxModel.Goal] forState:UIControlStateNormal];
        [self.dxCenterBtn setAttributedTitle:[BIMMethods withContent:self.dxCenterBtn.titleLabel.text WithContColor:UIColorHex(#151515) WithContentFont:font12 WithText:@"" WithTextColor:UIColorHex(#151515) WithTextFont:font12] forState:UIControlStateNormal];
        [self.dxCenterBtn setAttributedTitle:[BIMMethods withContent:self.dxCenterBtn.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font12 WithText:self.dxCenterBtn.titleLabel.text WithTextColor:[UIColor whiteColor] WithTextFont:font12] forState:UIControlStateSelected];
        
        [self.btnLittle setTitle:[NSString stringWithFormat:@"小        %.2f", [dxModel.DownOdds floatValue]] forState:UIControlStateNormal];
        [self.btnLittle setAttributedTitle:[BIMMethods withContent:self.btnLittle.titleLabel.text WithContColor:UIColorHex(#151515) WithContentFont:font12 WithText:@"小" WithTextColor:UIColorHex(#151515) WithTextFont:font12] forState:UIControlStateNormal];
        [self.btnLittle setAttributedTitle:[BIMMethods withContent:self.btnLittle.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font12 WithText:self.btnLittle.titleLabel.text WithTextColor:[UIColor whiteColor] WithTextFont:font12] forState:UIControlStateSelected];
    }
...
- (BIMZhumaViewOfFabuTuijian *)viewZhuma
{
    if (!_viewZhuma) {
        _viewZhuma = [[BIMZhumaViewOfFabuTuijian alloc] initWithFrame:CGRectMake(0, self.describeLab.bottom + 10, Width, 145)];
...
- (UILabel *)textViewPlaceholder
{
    if (!_textViewPlaceholder) {
        ...
        _textViewPlaceholder.attributedText = [BIMMethods setTextStyleWithString:@"推荐内容需原创，请提供详细分析或盘赔解读，涉及广告、抄袭等违规或过于简单将取消分析师资格哦！" WithLineSpace:4 WithHeaderIndent:0];
    }
...
- (void)uploadImage{
    ...
    [[BIMDCHttpRequest shareInstance] sendRequestByMethod:@"post" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url_ZiXunUrl] ArrayFile:[_textView.attributedText getImgaeArray] Start:^(id requestOrignal) {
...
- (void)fabuTuijianWithHtml:(NSString *)htmlStr withContent:(NSString *)contentStr
{
    ...
    [[BIMDCHttpRequest shareInstance] sendRequestByMethod:@"post" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server, url_addrecommend] ArrayFile:nil Start:^(id requestOrignal) {
    } End:^(id responseOrignal) {
    } Success:^(id responseResult, id responseOrignal) {
        ...
        if ([[responseOrignal objectForKey:@"code"] isEqualToString:@"200"]) {
            ...
            BIMFaBuSucceedVCViewController *fabuVC = [BIMFaBuSucceedVCViewController new];
...
- (void)updateModel
{
    ...
    [[BIMDCHttpRequest shareInstance] sendGetRequestByMethod:@"get" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url_SingalRecommendMatch] Start:^(id requestOrignal) {
    } End:^(id responseOrignal) {
    } Success:^(id responseResult, id responseOrignal) {
        if ([[responseOrignal objectForKey:@"code"] isEqualToString:@"200"]) {
            _model.rq = [BIMDxModel arrayOfEntitiesFromArray:[[[responseOrignal objectForKey:@"data"] objectForKey:@"instantOdds"] objectForKey:@"rq"]];
            _model.spf = [BIMDxModel arrayOfEntitiesFromArray:[[[responseOrignal objectForKey:@"data"] objectForKey:@"instantOdds"] objectForKey:@"spf"]];
            _model.dx = [BIMDxModel arrayOfEntitiesFromArray:[[[responseOrignal objectForKey:@"data"] objectForKey:@"instantOdds"] objectForKey:@"dx"]];
            _model.priceList = [BIMPriceListModel arrayOfEntitiesFromArray:[[responseOrignal objectForKey:@"data"] objectForKey:@"priceList"]];
