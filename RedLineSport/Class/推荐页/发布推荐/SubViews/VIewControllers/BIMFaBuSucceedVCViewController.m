...
@interface BIMFaBuSucceedVCViewController ()
...
@end
@implementation BIMFaBuSucceedVCViewController
...
- (void)jiXvClick {
    ...
    if ([array[1] isKindOfClass:NSClassFromString(@"BIMFabuTuijianSelectedItemVC")]) {
...
- (void)loadTuiJianDetailView {
    BIMTuijianDetailVC *tuijianDetailVC = [BIMTuijianDetailVC new];
