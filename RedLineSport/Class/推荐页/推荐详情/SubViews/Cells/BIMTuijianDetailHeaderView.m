#import "BIMTuijianDetailHeaderView.h"
#import "BIMDC_JZAPhotoVC.h"
#import "BIMLiveScoreModel.h"
#import "BIMFenxiPageVC.h"
#import "BIMUserViewOfTuijianCellCopy.h"

@interface BIMTuijianDetailHeaderView()<UIWebViewDelegate>
@property (nonatomic, assign) BOOL didSetupConstraints;
@property (nonatomic, strong) UIView *basicView;
@property (nonatomic, strong) BIMUserViewOfTuijianCellCopy *headerUser;
...
@end
@implementation BIMTuijianDetailHeaderView
...
- (void)setModel:( BIMTuijiandatingModel*)model
{
    _model = model;
    NSString *time = [BIMMethods formatYYMMDDWithStamp:model.create_time / 1000];
    self.timeLab.text = [NSString stringWithFormat:@"发布于%@",[BIMMethods compareCurrentTime:time]];
    ...
    _labSaishi.textColor = [BIMMethods getColor:_model.leagueColor];
    ...
    if (_model.spf.count>0) {
        ...
        [_btnWin setAttributedTitle:[BIMMethods withContent:_btnWin.currentTitle WithContColor:color66 WithContentFont:font12 WithText:@"胜" WithTextColor:color33 WithTextFont:font14] forState:UIControlStateNormal];
        [_btnPing setAttributedTitle:[BIMMethods withContent:_btnPing.currentTitle WithContColor:color66 WithContentFont:font12 WithText:@"平" WithTextColor:color33 WithTextFont:font14] forState:UIControlStateNormal];
        [_btnLose setAttributedTitle:[BIMMethods withContent:_btnLose.currentTitle WithContColor:color66 WithContentFont:font12 WithText:@"负" WithTextColor:color33 WithTextFont:font14] forState:UIControlStateNormal];
        [_btnWin setAttributedTitle:[BIMMethods withContent:_btnWin.currentTitle WithContColor:_model.see? [UIColor whiteColor]:color33 WithContentFont:font12 WithText:@"胜" WithTextColor:_model.see? [UIColor whiteColor]:color33 WithTextFont:font14] forState:UIControlStateSelected];
        [_btnPing setAttributedTitle:[BIMMethods withContent:_btnPing.currentTitle WithContColor:_model.see? [UIColor whiteColor]:color33 WithContentFont:font12 WithText:@"平" WithTextColor:_model.see? [UIColor whiteColor]:color33 WithTextFont:font14] forState:UIControlStateSelected];
        [_btnLose setAttributedTitle:[BIMMethods withContent:_btnLose.currentTitle WithContColor:_model.see? [UIColor whiteColor]:color33 WithContentFont:font12 WithText:@"负" WithTextColor:_model.see? [UIColor whiteColor]:color33 WithTextFont:font14] forState:UIControlStateSelected];
        ...
        [_btnWin setAttributedTitle:[BIMMethods withContent:_btnWin.currentTitle WithContColor:color66 WithContentFont:font12 WithText:@"主" WithTextColor:color33 WithTextFont:font14] forState:UIControlStateNormal];
        [_btnLose setAttributedTitle:[BIMMethods withContent:_btnLose.currentTitle WithContColor:color66 WithContentFont:font12 WithText:@"客" WithTextColor:color33 WithTextFont:font14] forState:UIControlStateNormal];
        [_btnWin setAttributedTitle:[BIMMethods withContent:_btnWin.currentTitle WithContColor:_model.see? [UIColor whiteColor]:color33 WithContentFont:font12 WithText:@"主" WithTextColor:_model.see? [UIColor whiteColor]:color33 WithTextFont:font14] forState:UIControlStateSelected];
        [_btnLose setAttributedTitle:[BIMMethods withContent:_btnLose.currentTitle WithContColor:_model.see? [UIColor whiteColor]:color33 WithContentFont:font12 WithText:@"客" WithTextColor:_model.see? [UIColor whiteColor]:color33 WithTextFont:font14] forState:UIControlStateSelected];
        _model.see ? ([_btnPing setBackgroundImage:[UIImage imageNamed:@"publish_odds_selected"] forState:UIControlStateSelected]):([_btnPing setBackgroundImage:[UIImage imageNamed:@"publish_odds_white"] forState:UIControlStateSelected]);
        _model.see ? ([_btnLose setBackgroundImage:[UIImage imageNamed:@"publish_odds_selected"] forState:UIControlStateSelected]):([_btnLose setBackgroundImage:[UIImage imageNamed:@"publish_odds_default"] forState:UIControlStateSelected]);
        _model.see ? ([_btnWin setBackgroundImage:[UIImage imageNamed:@"publish_odds_selected"] forState:UIControlStateSelected]):([_btnWin setBackgroundImage:[UIImage imageNamed:@"publish_odds_default"] forState:UIControlStateSelected]);
        ...
        [_btnWin setAttributedTitle:[BIMMethods withContent:_btnWin.currentTitle WithContColor:color66 WithContentFont:font12 WithText:@"大" WithTextColor:color33 WithTextFont:font14] forState:UIControlStateNormal];
        [_btnLose setAttributedTitle:[BIMMethods withContent:_btnLose.currentTitle WithContColor:color66 WithContentFont:font12 WithText:@"小" WithTextColor:color33 WithTextFont:font14] forState:UIControlStateNormal];
        [_btnWin setAttributedTitle:[BIMMethods withContent:_btnWin.currentTitle WithContColor:_model.see? [UIColor whiteColor]:color33 WithContentFont:font12 WithText:@"大" WithTextColor:_model.see? [UIColor whiteColor]:color33 WithTextFont:font14] forState:UIControlStateSelected];
        [_btnLose setAttributedTitle:[BIMMethods withContent:_btnLose.currentTitle WithContColor:_model.see? [UIColor whiteColor]:color33 WithContentFont:font12 WithText:@"小" WithTextColor:_model.see? [UIColor whiteColor]:color33 WithTextFont:font14] forState:UIControlStateSelected];
    ...
    if (_type == TuijianDetailHeaderViewShowContent) {
        if (_model.contentInfo!= nil && ![_model.contentInfo isEqualToString:@""]) {
            ...
            [_labContent setAttributedText:[BIMMethods setTextStyleWithString:_model.content WithLineSpace:5 WithHeaderIndent:0]];
            [self.webView mas_updateConstraints:^(MASConstraintMaker *make) {
...
- (UIView *)basicView
{
    NSLog(@"BIMTuijianDetailHeaderView677-%zd", _type);
    if (!_basicView) {
...
- (BIMUserViewOfTuijianCellCopy *)headerUser
{
    if (!_headerUser) {
        _headerUser = [[BIMUserViewOfTuijianCellCopy alloc] init];
    }
    return _headerUser;
}
...
- (void)btnToBiFenClick{
    ...
    [[BIMDCHttpRequest shareInstance] sendGetRequestByMethod:@"get" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,@"/match"] Start:^(id requestOrignal) {
    } End:^(id responseOrignal) {
    } Success:^(id responseResult, id responseOrignal) {
        BIMLiveScoreModel *scoremodel = [BIMLiveScoreModel entityFromDictionary:responseOrignal[@"data"]];
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType {
    if ([request.URL.scheme isEqualToString:@"image-preview"]) {
        ...
        BIMDC_JZAPhotoVC *album = [[BIMDC_JZAPhotoVC alloc] init];
...
- (void)addLikedHated:(UIButton *)btn
{
    ...
    NSMutableDictionary *paremeter = [NSMutableDictionary dictionaryWithDictionary:[BIMHttpString getCommenParemeter]];
    ...
    [[BIMDCHttpRequest shareInstance] sendRequestByMethod:@"post" WithParamaters:paremeter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url_likeAdd] ArrayFile:nil Start:^(id requestOrignal) {
    } End:^(id responseOrignal) {
    } Success:^(id responseResult, id responseOrignal) {
...
- (void)sendReportInfomationWithcategory:(NSString *)category
{
    ...
    [[BIMDCHttpRequest shareInstance] sendRequestByMethod:@"post" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url_illegaladd] ArrayFile:nil Start:^(id requestOrignal) {
    } End:^(id responseOrignal) {
    } Success:^(id responseResult, id responseOrignal) {
        if ([[responseOrignal objectForKey:@"code"] isEqualToString:@"200"]) {
