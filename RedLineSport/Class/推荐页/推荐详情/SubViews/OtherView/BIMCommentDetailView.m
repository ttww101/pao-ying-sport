...
@interface BIMCommentDetailView()
...
@end
@implementation BIMCommentDetailView
- (void)setModel:(BIMCommentChildModel *)model
{
    _model = model;
    ...
    [_btnUser setAttributedTitle:[BIMMethods withContent:_btnUser.currentTitle WithContColor:color4C8DE5 WithContentFont:font14 WithText:@"回复" WithTextColor:color33 WithTextFont:font14] forState:UIControlStateNormal];
    [_labContent setAttributedText:[BIMMethods setTextStyleWithString:_model.content WithLineSpace:3 WithHeaderIndent:0]];
    if (!_addAutoLayout) {
        [self adAutoLayout];
        _addAutoLayout = YES;
    }
