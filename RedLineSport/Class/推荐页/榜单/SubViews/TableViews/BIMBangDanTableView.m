...
@interface BIMBangDanTableView()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
@end
@implementation BIMBangDanTableView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    BIMBangDanListCell *cell = [tableView dequeueReusableCellWithIdentifier:acell];
    if (!cell) {
        cell = [[BIMBangDanListCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:acell];
    }
