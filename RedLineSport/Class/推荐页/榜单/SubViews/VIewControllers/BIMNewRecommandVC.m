...
#import "BIMBangDanTableView.h"
#import "BIMRecommandListModel.h"
@interface BIMNewRecommandVC ()<PageScrollViewDateSource,PageScrollViewDelegate,TitleIndexViewDelegate>
@property (nonatomic, strong) BIMPageScrollView *scrollView;
@property (nonatomic, strong) BIMTitleIndexView *titleView;
@property (nonatomic, strong)BIMBangDanTableView *tableView;
@property (nonatomic, strong)BIMBangDanTableView *tableViewWeek;
@property (nonatomic, strong)BIMBangDanTableView *tableViewMon;
@property (nonatomic, strong)BIMBangDanTableView *tableViewAll;
...
@end
@implementation BIMNewRecommandVC
...
- (void)setNumGetData:(NSInteger)num{
    ...
    NSString *uBIMtr = url_rankingquery;
    switch (num) {
        case 0:
        {
    ...
    [self loadDataRecommandListParameter:parameter uBIMtr:uBIMtr num:num];
}
- (void)setNumGetDataTwo{
    ...
    uBIMtr = url_rankingquery;
    [self loadDataRecommandListParameter:parameter uBIMtr:uBIMtr num:0];
}
...
- (void)setNavView{
    ...
    _titleView = [[BIMTitleIndexView alloc] initWithFrame:CGRectMake(0, APPDELEGATE.customTabbar.height_myNavigationBar, Width, 50)];
    ...
    if (self.typeList == typeListOne) {
        ...
        _scrollView = [[BIMPageScrollView alloc] initWithFrame:CGRectMake(0, APPDELEGATE.customTabbar.height_myNavigationBar, Width, Height - APPDELEGATE.customTabbar.height_myNavigationBar)];
    }
...
- (void)loadDataRecommandListParameter:(NSMutableDictionary *)parameterDic uBIMtr:(NSString *)url num:(NSInteger)num
{
    [BIMLodingAnimateView showLodingView];
    [[BIMDCHttpRequest shareInstance] sendGetRequestByMethod:@"get" WithParamaters:parameterDic PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url] Start:^(id requestOrignal) {
        ...
        if ([[responseOrignal objectForKey:@"code"] isEqualToString:@"200"]) {
            ...
            if (self.typeList == typeListOne) {
                switch (num) {
                    case 0:{
                        _arrData = [[NSArray alloc] initWithArray:[BIMRecommandListModel arrayOfEntitiesFromArray:[responseOrignal objectForKey:@"data"]]];
                        self.defaultFailure = @"暂无数据";
                        NSLog(@"%@",responseOrignal);
                    }
                        break;
                    case 1:{
                        _arrDataTwo = [[NSArray alloc] initWithArray:[BIMRecommandListModel arrayOfEntitiesFromArray:[responseOrignal objectForKey:@"data"]]];
                    }
                        break;
                    case 2:{
                        _arrDataThree = [[NSArray alloc] initWithArray:[BIMRecommandListModel arrayOfEntitiesFromArray:[responseOrignal objectForKey:@"data"]]];
                    }
                        break;
                    case 3:{
                        _arrDataFour = [[NSArray alloc] initWithArray:[BIMRecommandListModel arrayOfEntitiesFromArray:[responseOrignal objectForKey:@"data"]]];
                    }
                        break;
                    default:
                        break;
...
{
    _tableView = [[BIMBangDanTableView alloc] initWithFrame:CGRectMake(0, 0, Width, Height - APPDELEGATE.customTabbar.height_myNavigationBar) style:UITableViewStylePlain];
    ...
    if (self.typeList == typeListOne) {
        switch (index) {
            case 0:{
                ...
                break;
            case 1:{
                _tableViewWeek = [[BIMBangDanTableView alloc] initWithFrame:CGRectMake(Width * 1, 0, Width, Height - APPDELEGATE.customTabbar.height_myNavigationBar) style:UITableViewStylePlain];
                ...
                break;
            case 2:{
                _tableViewMon = [[BIMBangDanTableView alloc] initWithFrame:CGRectMake(Width * 2, 0, Width, Height - APPDELEGATE.customTabbar.height_myNavigationBar) style:UITableViewStylePlain];
                ...
                break;
            case 3:{
                _tableViewAll = [[BIMBangDanTableView alloc] initWithFrame:CGRectMake(Width * 3, 0, Width, Height - APPDELEGATE.customTabbar.height_myNavigationBar) style:UITableViewStylePlain];
