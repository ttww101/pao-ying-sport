#import "BIMBangDanListCell.h"
@interface BIMBangDanListCell()
...
@end
@implementation BIMBangDanListCell
...
- (void)setModel:(BIMRecommandListModel *)model{
    _model = model;
    ...
    if (self.type == 1 || self.type == 5) {
        ...
        self.labSession.attributedText = [BIMMethods withContent:self.labSession.text contentColor:color33 WithColorText:model.realnums textColor:color66];
    }else{
        ...
        if (self.type == 4 || self.type == 3) {
            ...
            self.labWinRate.attributedText = [BIMMethods withContent:self.labWinRate.text WithColorText:@"%" textColor:color33 strFont:font14];
        }
    }
...
- (void)tapBasicView
{
    ...
    BIMUserViewController *user = [[BIMUserViewController alloc] init];
