...
@interface BIMNoticePageVC ()<ViewPagerDelegate,ViewPagerDataSource,NavViewDelegate>
@property (nonatomic, assign) NSInteger currentIndex;
@property (nonatomic, strong) UISegmentedControl *segmentEvent;
@end
@implementation BIMNoticePageVC
...
- (UIViewController *)viewPager:(BIMViewPagerController *)viewPager contentViewControllerForTabAtIndex:(NSUInteger)index
{
    switch (index) {
        case 0:
        {
            BIMRemindViewController *noticeVC = [[BIMRemindViewController alloc] init];
            return noticeVC;
        }
            break;
        case 1:
        {
            BIMNoticeViewController *noticeVC = [[BIMNoticeViewController alloc] init];
            return noticeVC;
        }
            break;
        default:
