#import "BIMChangePassWordVC.h"
@interface BIMChangePassWordVC ()
...
@end
@implementation BIMChangePassWordVC
...
- (void)ConfireBtnRequest
{
    ...
    [parameter setObject:[BIMMethods md5WithString:self.txtOldNum.text] forKey:@"oldpsw"];
    [parameter setObject:[BIMMethods md5WithString:self.txtNewNum.text] forKey:@"newpsw"];
