...
@property (nonatomic , strong) BIMHeaderAmountView *amountView;
@property (nonatomic, strong) UILabel *desLabel;
@property (nonatomic, strong) UIControl *control;
@property (nonatomic , strong) BIMHeaderControl *leftControl;
@property (nonatomic , strong) BIMHeaderControl *centerControl;
@property (nonatomic , strong) BIMHeaderControl *rightControl;
...
@implementation BIMMineHeaderView
...
//        }
        ...
        NSString *imageName = [BIMMethods getPersonLeavelImageName:_model.analysttype];
...
- (void)avatarClick {
    if ([BIMMethods login]) {
        BIMMyProfileVC *myProfile = [[BIMMyProfileVC alloc] init];
...
- (void)centerControlAction {
    ...
    BIMFriendsVC *friend = [[BIMFriendsVC alloc] init];
...
- (BIMHeaderAmountView *)amountView {
    if (_amountView == nil) {
        _amountView = [[BIMHeaderAmountView alloc]initWithFrame:CGRectMake(15, 165, Width - 30, 60)];
    }
    return _amountView;
}
- (UILabel *)desLabel {
...
- (BIMHeaderControl *)leftControl {
    if (_leftControl == nil) {
        _leftControl = [[BIMHeaderControl alloc]initWithFrame:CGRectMake(0, 125, self.controlWidth, 30) content:@"推荐:0" showRightLine:true];
        [_leftControl addTarget:self action:@selector(leftControlAction) forControlEvents:UIControlEventTouchUpInside];
    }
    return _leftControl;
}
- (BIMHeaderControl *)centerControl {
    if (_centerControl == nil) {
        _centerControl = [[BIMHeaderControl alloc]initWithFrame:CGRectMake(50, 120, self.controlWidth, 30) content:@"关注:0" showRightLine:true];
...
- (BIMHeaderControl *)rightControl {
    if (_rightControl == nil) {
        _rightControl = [[BIMHeaderControl alloc]initWithFrame:CGRectMake(self.centerControl.right, 120, self.controlWidth, 30) content:@"粉丝:0" showRightLine:true];
