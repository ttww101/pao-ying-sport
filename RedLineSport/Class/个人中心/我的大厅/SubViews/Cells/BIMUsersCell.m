...
#import "BIMUserTuiianView.h"
#import "BIMUserTuijianVC.h"
#import "BIMSignatureVC.h"
#import "BIMNoticePageVC.h"
#import "BIMMyProfileVC.h"
@interface BIMUsersCell()<UserTuiianViewDelegate,UIGestureRecognizerDelegate,UINavigationControllerDelegate>
...
- (void)setModel:(BIMUserModel *)model
{
    ...
    _labGZ.hidden = ![BIMMethods login];
    _labFS.hidden = ![BIMMethods login];
    _labGZNum.hidden = ![BIMMethods login];
    _labFSNum.hidden = ![BIMMethods login];
    if ([BIMMethods login]) {
