...
@interface BIMMineTableViewCell ()
...
@end
@implementation BIMMineTableViewCell
static CGFloat cell_Height = 44;
static NSString *identifier = @"listCell";
+ (BIMMineTableViewCell *)cellForTableView:(UITableView *)tableView {
    BIMMineTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
        cell = [[BIMMineTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
