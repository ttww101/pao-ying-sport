...
@interface BIMOldMineViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@end
@implementation BIMOldMineViewController
...
{
    if ([BIMMethods login]) {
        BIMNoticePageVC *noticeVC = [[BIMNoticePageVC alloc] init];
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        [_tableView registerClass:[BIMUsersCell class] forCellReuseIdentifier:cellMineViewControllerUserCell];
...
- (void)renzheng
{
    BIMRealNameCerVC *real = [[BIMRealNameCerVC alloc] init];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    switch (indexPath.section) {
        case 0:
        {
                return [tableView fd_heightForCellWithIdentifier:cellMineViewControllerUserCell configuration:^(BIMUsersCell* cell) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
            BIMUsersCell *cell = [tableView dequeueReusableCellWithIdentifier:cellMineViewControllerUserCell];
            if (!cell) {
                cell = [[BIMUsersCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellMineViewControllerUserCell];
            }
        ...
        case 2:
        {
            switch (indexPath.row) {
                ...
                case 1:
                {
                    ...
                    BIMUserModel *model = [BIMMethods getUserModel];
                    BIMAnQuanCenterVC *anquanVc = [[BIMAnQuanCenterVC alloc] init];
...
- (void)loadUserInfo
{
    ...
    [[BIMDCHttpRequest shareInstance] sendGetRequestByMethod:@"get" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url_userinfo] Start:^(id requestOrignal) {
