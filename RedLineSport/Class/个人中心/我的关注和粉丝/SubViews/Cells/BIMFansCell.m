#import "BIMFansCell.h"
@interface BIMFansCell()
...
- (void)setModel:(BIMFansModel *)model
{
    _model = model;
    ...
    _labFocus.attributedText = [BIMMethods withContent:[NSString stringWithFormat:@"关注%ld",_model.focus_count] contentColor:color33 WithColorText:@"关注" textColor:color99];
    _labfollower.attributedText = [BIMMethods withContent:[NSString stringWithFormat:@"粉丝%ld",_model.follower_count] contentColor:color33 WithColorText:@"粉丝" textColor:color99];
