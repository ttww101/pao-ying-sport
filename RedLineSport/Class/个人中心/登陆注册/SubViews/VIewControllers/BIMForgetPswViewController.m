...
@property (nonatomic, strong) BIMJKCountDownButton *getCheckBTn;
@property (nonatomic, strong) MBProgressHUD *prograssHud;
@property (nonatomic, retain)NSMutableArray *arrImg;
@end
@implementation BIMForgetPswViewController
...
- (void)creatForgetPsw
{
    ...
    _getCheckBTn = [[BIMJKCountDownButton alloc] initWithFrame:CGRectMake(_checkTextF.frame.origin.x + _checkTextF.frame.size.width - 10, textHeight + 10, 80, textHeight - 20)];
