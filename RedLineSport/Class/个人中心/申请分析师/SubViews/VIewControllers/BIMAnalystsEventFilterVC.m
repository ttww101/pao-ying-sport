...
@interface BIMAnalystsEventFilterVC ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
@property (nonatomic, strong) UICollectionView *collectionView;
@property (nonatomic, strong) NSArray *arrData;
@property (nonatomic, strong) NSMutableArray *arrBtn;
@property (nonatomic, strong) NSMutableArray *selectBtn;
@end
@implementation BIMAnalystsEventFilterVC
