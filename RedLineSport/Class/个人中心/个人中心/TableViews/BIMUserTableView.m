#import "BIMUserTableView.h"
@interface BIMUserTableView()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
@property (nonatomic, strong) NSString *defaultFailure;
@property (nonatomic, strong) NSArray *arrData;
@end
@implementation BIMUserTableView
