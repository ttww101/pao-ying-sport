#import "BIMUserOfOtherCell.h"
#import "BIMDC_JZAPhotoVC.h"
#import "BIMUserTuiianView.h"
#import "BIMUsermarkModel.h"
@interface BIMUserOfOtherCell()<UserTuiianViewDelegate>
...
@property (nonatomic, strong) BIMUserTuiianView *viewTuijian;
...
@end
@implementation BIMUserOfOtherCell
- (void)awakeFromNib {
    [super awakeFromNib];
}
- (void)setModel:(BIMUserModel *)model
{
    ...
    [_labUserIntro setAttributedText:[BIMMethods setTextStyleWithString:_model.userinfo WithLineSpace:6 WithHeaderIndent:0]];
...
- (BIMUserTuiianView *)viewTuijian
{
    if (!_viewTuijian) {
        _viewTuijian = [[BIMUserTuiianView alloc] init];
