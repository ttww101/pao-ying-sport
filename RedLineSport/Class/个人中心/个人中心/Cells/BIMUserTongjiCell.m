...
#define cellUserTongjiCollection @"BIMUserTongjiCollectioncell"
@interface BIMUserTongjiCell()<UICollectionViewDataSource, UICollectionViewDelegate>
...
@end
@implementation BIMUserTongjiCell
...
- (void)setModel:(BIMUserTongjiAllModel *)model
{
    _model = model;
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[BIMUserTongjiCollectioncell class] forCellWithReuseIdentifier:cellUserTongjiCollection];
...
{
    BIMUserTongjiCollectioncell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellUserTongjiCollection forIndexPath:indexPath];
    if (_model) {
