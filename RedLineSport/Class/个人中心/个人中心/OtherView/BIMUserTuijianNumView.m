...
@implementation BIMUserTuijianNumView
    ...
    for (int i = 0; i<3; i++) {
        ...
        switch (i) {
            case 0:
            {
                ...
                [labTitle setAttributedText:[BIMMethods withContent:labTitle.text WithColorText:[NSString stringWithFormat:@"%ld",(long)_model.winNum] textColor:redcolor strFont:font12]];
            ...
            case 1:
            {
                ...
                [labTitle setAttributedText:[BIMMethods withContent:labTitle.text WithColorText:[NSString stringWithFormat:@"%ld",(long)_model.goNum] textColor:redcolor strFont:font12]];
            ...
            case 2:
            {
                ...
                [labTitle setAttributedText:[BIMMethods withContent:labTitle.text WithColorText:[NSString stringWithFormat:@"%ld",(long)_model.loseNum] textColor:redcolor strFont:font12]];
