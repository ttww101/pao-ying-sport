...
@interface BIMSucessViewOfSignatureView()
@property (nonatomic, strong)UIImageView *img;
@property (nonatomic, strong)UILabel *labSucc;
@property (nonatomic, strong)UILabel *labContent;
@end
@implementation BIMSucessViewOfSignatureView
- (instancetype)initWithFrame:(CGRect)frame{
    if (self == [super initWithFrame:frame]) {
        ...
        _labContent.attributedText = [BIMMethods withContent:_labContent.text WithColorText:seconds textColor:redcolor strFont:font14];
    }
    return self;
}
