...
#import "BIMSucessViewOfSignatureView.h"
@interface BIMSignatureVC ()<UITextViewDelegate>
@property (nonatomic, strong)UILabel *labPlarch;
@property (nonatomic, strong)UITextView *txtView;
@property (nonatomic, weak)BIMNavView *navV;
@property (nonatomic, assign) BOOL successed;
@end
@implementation BIMSignatureVC
    ...
    if (index == 1) {
        ...
        [[BIMDCHttpRequest shareInstance] sendRequestByMethod:@"post" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url_loginAndRegister] ArrayFile:nil Start:^(id requestOrignal) {
            ...
            if ([[responseOrignal objectForKey:@"code"] isEqualToString:@"200"]) {
                ...
                BIMSucessViewOfSignatureView *successView = [[BIMSucessViewOfSignatureView alloc] initWithFrame:CGRectMake(0, APPDELEGATE.customTabbar.height_myNavigationBar, Width, Height - APPDELEGATE.customTabbar.height_myNavigationBar) ];
