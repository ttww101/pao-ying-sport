...
@interface BIMFeedbackNewVC ()<UITableViewDelegate,UITableViewDataSource,UITextViewDelegate>
...
@end
@implementation BIMFeedbackNewVC
- (void)viewDidLoad {
    [super viewDidLoad];
    [self setNavView];
...
- (BIMFeedBackHeaderView *)feedBackHeaderView {
    if (!_feedBackHeaderView) {
        _feedBackHeaderView = [[BIMFeedBackHeaderView alloc] initWithFrame:CGRectMake(12, APPDELEGATE.customTabbar.height_myNavigationBar + 10, Width - 30, 331)];
    }
