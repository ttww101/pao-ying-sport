...
#import "BIMForumViewController.h"
#import "HeaderView.h"
...
@interface BIMForumViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation BIMForumViewController
...
- (void)loadData {
    ...
    [[BIMDCHttpRequest shareInstance]sendGetRequestByMethod:@"get" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url_forum] Start:^(id requestOrignal) {
