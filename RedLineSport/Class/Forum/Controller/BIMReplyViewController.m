...
@interface BIMReplyViewController () <UITextViewDelegate>
...
@implementation BIMReplyViewController
...
- (void)upContent {
    ...
    [[BIMDCHttpRequest shareInstance]sendRequestByMethod:@"post" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,urlPath] ArrayFile:nil Start:^(id requestOrignal) {
