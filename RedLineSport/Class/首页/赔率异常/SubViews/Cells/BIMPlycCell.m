...
- (BIMPeilvViewOfPlyc *)peilvView
{
    if (!_peilvView) {
        _peilvView = [[BIMPeilvViewOfPlyc alloc] init];
    }
    return _peilvView;
}
- (void)addlayout
