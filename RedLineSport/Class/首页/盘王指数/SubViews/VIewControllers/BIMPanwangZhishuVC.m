...
@interface BIMPanwangZhishuVC ()<TitleIndexViewDelegate,UICollectionViewDataSource, UICollectionViewDelegate>
@property (nonatomic, weak) UICollectionView *mainView; 
@property (nonatomic, weak) UICollectionViewFlowLayout *flowLayout;
@property (nonatomic, strong) BIMTitleIndexView *titleView;
@property (nonatomic, assign) NSInteger currentIndex;
@end
@implementation BIMPanwangZhishuVC
...
- (void)viewDidLoad {
    ...
    [mainView registerClass:[BIMPanwangCollectCell class] forCellWithReuseIdentifier:cellPanwangCollect];
...
{
    BIMPanwangCollectCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellPanwangCollect forIndexPath:indexPath];
