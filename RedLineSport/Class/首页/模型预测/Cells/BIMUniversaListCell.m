...
@end
@interface BIMUniversaListCell ()
@property (nonatomic , strong) UIImageView *leftIcon;
@property (nonatomic , strong) UILabel *titleLabel;
@end
@implementation BIMUniversaListCell
static CGFloat cell_Height = 60;
static NSString *identifier = @"listCell";
static CGFloat imageHeight = 40;
+ (BIMUniversaListCell *)cellForTableView:(UITableView *)tableView {
    BIMUniversaListCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
        cell = [[BIMUniversaListCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
