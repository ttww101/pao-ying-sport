...
@interface BIMLiveListTableViewCell ()
...
@end
@implementation BIMLiveListTableViewCell
...
+ (BIMLiveListTableViewCell *)cellForTableView:(UITableView *)tableView {
    BIMLiveListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
        cell = [[BIMLiveListTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
...
- (void)refreshContentData:(BIMLiveListModel *)model {
    self.matchTimeLabel.text = [BIMMethods formatHHSSStamp:model.startTime];
    ...
    [self.homeTermIcon sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://ls.sportradar.com/ls/crest/small/%@.png",model.homeUid]] placeholderImage:[BIMMethods defaultPlaceHolderImage:@"default_home_icon"]];
    [self.VisitingTermIcon sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://ls.sportradar.com/ls/crest/small/%@.png",model.awayUid]] placeholderImage:[BIMMethods defaultPlaceHolderImage:@"default_home_icon"]];
