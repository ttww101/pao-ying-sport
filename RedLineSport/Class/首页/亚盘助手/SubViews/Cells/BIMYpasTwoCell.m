...
- (BIMPeilvViewofYapsTwoCell *)peilvView
{
    if (!_peilvView) {
        _peilvView = [[BIMPeilvViewofYapsTwoCell alloc] init];
    }
    return _peilvView;
}
- (UIView *)viewLine
