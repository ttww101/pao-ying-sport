...
@interface BIMTongpeiDetailCell()
...
@end
@implementation BIMTongpeiDetailCell
- (void)awakeFromNib {
    [super awakeFromNib];
}
...
- (void)setModel:(BIMTongPeiMatchModel *)model
{
    _model = model;
    ...
    _labWin.backgroundColor = [BIMMethods getColor:_model.resultColor];
