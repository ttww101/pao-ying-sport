#define cellTongpeiHistory @"BIMTongpeiHistoryCell"
#define cellTongpeiPeilvChange @"cellTongpeiPeilvChange"
#import "BIMTongPeiPeiLvDTVC.h"
#import "BIMTongpeiHistoryCell.h"
#import "BIMTongpeiPeilvChangeCell.h"
#import "BIMTongpeiPeilvChangeTItleView.h"
@interface BIMTongPeiPeiLvDTVC ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
@property (nonatomic, strong) UITableView *tableView;
@end
@implementation BIMTongPeiPeiLvDTVC
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        [_tableView registerClass:[BIMTongpeiHistoryCell class] forCellReuseIdentifier:cellTongpeiHistory];
        [_tableView registerClass:[BIMTongpeiPeilvChangeCell class] forCellReuseIdentifier:cellTongpeiPeilvChange];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    labTitle.text = @"指数变化";
    [header addSubview:labTitle];
    BIMTongpeiPeilvChangeTItleView *viewListTitle = [[BIMTongpeiPeilvChangeTItleView alloc] initWithFrame:CGRectMake(0, labTitle.bottom, Width, 30)];
...
{
    if (indexPath.section == 0) {
        BIMTongpeiHistoryCell *cell = [tableView dequeueReusableCellWithIdentifier:cellTongpeiHistory];
        if (!cell) {
            cell = [[BIMTongpeiHistoryCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellTongpeiHistory];
        }
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
        cell.data = @"";
        return cell;
    }
    BIMTongpeiPeilvChangeCell *cell = [tableView dequeueReusableCellWithIdentifier:cellTongpeiPeilvChange];
    if (!cell) {
        cell = [[BIMTongpeiPeilvChangeCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellTongpeiPeilvChange];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    cell.data = @"";
    return cell;
