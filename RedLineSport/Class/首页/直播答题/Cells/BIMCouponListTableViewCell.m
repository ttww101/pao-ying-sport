...
@interface BIMCouponListTableViewCell ()
...
@end
@implementation BIMCouponListTableViewCell
static CGFloat cell_Height = 126.f;
static NSString *identifier = @"listCell";
+ (BIMCouponListTableViewCell *)cellForTableView:(UITableView *)tableView {
    BIMCouponListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
        cell = [[BIMCouponListTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
...
- (void)refreshContentData:(id)model {
    BIMCouponModel *dataMode = (BIMCouponModel *)model;
