...
@end
@implementation BIMWithdrawalView
- (instancetype)init {
...
- (void)setcontentWithData:(WithdrawaListModel *)model {
    NSString *text = [NSString stringWithFormat:@"%@元",PARAM_IS_NIL_ERROR([BIMMethods amountFormater:model.total_reward_amount])];
    ...
    [att addAttribute:NSFontAttributeName value:FONT_DIN_Bold_SIZE(60.f) range:[text rangeOfString:PARAM_IS_NIL_ERROR([BIMMethods amountFormater:model.total_reward_amount])]];
