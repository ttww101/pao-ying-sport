...
+ (instancetype)showPaymentInfo:(id)information
    ...
    static BIMLiveQuizAlertView *payView = nil;
    if (!payView) {
        payView = [[BIMLiveQuizAlertView alloc]initWithFrame:windowView.bounds];
    }
