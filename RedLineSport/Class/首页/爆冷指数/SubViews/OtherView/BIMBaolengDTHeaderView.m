...
@implementation BIMBaolengDTHeaderView
- (void)setModel:(BIMBaolengDTModel *)model
{
    _model = model;
    for (int i = 0; i<3; i++) {
        ...
        switch (i) {
            case 0:
            {
                ...
                labTitle.textColor = redcolor;
                labWin.textColor = color99;
                [labTitle setAttributedText:[BIMMethods withContent:labTitle.text WithColorText:@"%" textColor:labTitle.textColor strFont:font12]];
            }
                break;
            case 1:
            {
                ...
                labTitle.attributedText  = [BIMMethods withContent:labTitle.text WithColorText:@"场" textColor:color33 strFont:font12];
                labWin.textColor = color99;
                labWin.text = @"距上次爆冷";
            }
                break;
