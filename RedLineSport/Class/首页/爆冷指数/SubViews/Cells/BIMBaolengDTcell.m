...
@end
@implementation BIMBaolengDTcell
- (void)awakeFromNib {
    [super awakeFromNib];
}
...
- (void)setModel:(BIMBaolengMatchModel *)model
{
    _model = model;
    [self.contentView addSubview:self.basicView];
    _labLeague.text = _model.league;
    _labTime.text = [BIMMethods getDateByStyle:DateFormatterYearH withDate:[NSDate dateWithTimeIntervalSince1970:_model.matchtime/1000] ];
