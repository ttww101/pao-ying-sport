...
@interface BIMBaolengZhishuCell()
...
@end
@implementation BIMBaolengZhishuCell
- (void)awakeFromNib {
    [super awakeFromNib];
}
...
- (void)setModel:(BIMBaolengZishuModel *)model
{
    _model = model;
    ...
    _labTime.text = [BIMMethods getDateByStyle:dateStyleFormatterMdHm withDate:[NSDate dateWithTimeIntervalSince1970:_model.mtime/1000]];
    ...
    _labBaolengRate.attributedText = [BIMMethods withContent:_labBaolengRate.text WithColorText:@"%" textColor:_labBaolengRate.textColor strFont:font12];
