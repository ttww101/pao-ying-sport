...
#import "BIMDxModel.h"
@interface BIMFirstPInfoListModel : BIMBasicModel
...
@property (nonatomic, strong) BIMDxModel *ya;
@property (nonatomic, strong) BIMDxModel *spf;
@property (nonatomic, strong) BIMDxModel *dx;
