...
- (void)setModel:(BIMRedDanModel *)model{
    _model = model;
    ...
    self.labSL.attributedText = [BIMMethods withContent:self.labSL.text WithColorText:@"%" textColor:redcolor strFont:font17];
    ...
    self.labTime.text = [NSString stringWithFormat:@"%@",[BIMMethods getDateByStyle:@"MM-dd" withDate:[NSDate dateWithTimeIntervalSince1970:[model.matchTime doubleValue]/1000]]];
