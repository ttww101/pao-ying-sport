...
@interface BIMRedDanCycleView()<UICollectionViewDataSource, UICollectionViewDelegate>
@property (nonatomic, weak) UICollectionView *mainView; 
@property (nonatomic, weak) UICollectionViewFlowLayout *flowLayout;
@property (nonatomic, strong) UIPageControl *pagecontrol;
@end
@implementation BIMRedDanCycleView
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[BIMRedDanCell class] forCellWithReuseIdentifier:@"UICollectionViewCell"];
...
{
    BIMRedDanCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"UICollectionViewCell" forIndexPath:indexPath];
