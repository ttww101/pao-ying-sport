...
@interface BIMFirstPUserlistView()
@property (nonatomic, strong) UIView *basicView;
@end
@implementation BIMFirstPUserlistView
- (void)setArrData:(NSArray *)arrData
{
    ...
    [_arrData enumerateObjectsUsingBlock:^(BIMUserlistModel*  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        if (idx == 8) {
            return ;
        }
...
{
    BIMUserlistModel *mode = [_arrData objectAtIndex:btn.tag];
