...
@interface BIMWKWebView () <UIWebViewDelegate, WKNavigationDelegate>
...
- (void)loadBradgeHandler {
    __weak BIMWKWebView *weakSelf = self;
...
- (void)openNative:(id)data {
    if ([data isKindOfClass:[NSDictionary class]]) {
        ...
        if ([className isEqualToString:@"TuijianDetailVC"]) {
            className = @"BIMTuijianDetailVC";
        }
        if ([className isEqualToString:@"UserTuijianVC"]) {
            className = @"BIMUserTuijianVC";
        }
