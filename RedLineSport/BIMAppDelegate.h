...
@interface BIMAppDelegate : UIResponder <UIApplicationDelegate, UNUserNotificationCenterDelegate>
//@property (nonatomic, strong)BIMWebDetailViewController *webDetailVC;
@property (strong, nonatomic) UIWindow *window;
@property (strong, nonatomic) BIMDCTabBarController *customTabbar;
