#import "BIMLodingAnimateView.h"
@interface BIMLodingAnimateView()
@property (nonatomic, strong) UIView *basicV;
@end
@implementation BIMLodingAnimateView
+ (BIMLodingAnimateView*)basicView {
    static dispatch_once_t once;
    static BIMLodingAnimateView *sharedView;
