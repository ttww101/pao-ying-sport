...
#import "BIMWKWebViewController.h"
#import <WebKit/WebKit.h>
@interface BIMWKWebViewController ()<UIWebViewDelegate,UIActionSheetDelegate,WKNavigationDelegate>
{
    BIMLMJScrollTextView * _scrollTextView1;
}
...
@end
@implementation BIMWKWebViewController
...
- (void)setNavView
{
    ...
    nav.delegate = self;
    if ([BIMMethods getTextWidthSize:_strtitle strfont:font18] >(Width - 44*2 - 30*2)) {
        nav.labTitle.hidden = YES;
        _scrollTextView1 = [[BIMLMJScrollTextView alloc] initWithFrame:CGRectMake(0, 0, (Width - 44*2 - 30*2), 44) textScrollModel:LMJTextScrollContinuous direction:LMJTextScrollMoveLeft];
