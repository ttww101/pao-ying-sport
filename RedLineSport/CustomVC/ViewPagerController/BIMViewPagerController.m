...
@interface BIMViewPagerController () <UIScrollViewDelegate>
...
@end
@implementation BIMViewPagerController
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (self.currentIndex == 0 && scrollView.contentOffset.x < Width && self.canLimitBounce == YES) {
        scrollView.contentOffset = CGPointMake(Width, scrollView.contentOffset.y);
    } else if (self.currentIndex == (self.tabCount - 1) && scrollView.contentOffset.x > Width && self.canLimitBounce == YES) {
        scrollView.contentOffset = CGPointMake(Width, scrollView.contentOffset.y);
    }
}
