#import "BIMDCPageViewController.h"
@interface BIMDCPageViewController ()<UIPageViewControllerDelegate,UIPageViewControllerDataSource>
{
    NSInteger totalVC;         
    NSArray *VCArray;          
    NSArray *buttonArray;      
...
@end
@implementation BIMDCPageViewController
- (void)viewDidLoad {
    [super viewDidLoad];
