...
@implementation BIMTFFileUploadManager{
...
+(instancetype)shareInstance{
    static BIMTFFileUploadManager *manager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [[BIMTFFileUploadManager alloc]init];
    });
    return manager;
}
-(void)uploadFileWithURL:(NSString *)uBIMtring params:(NSDictionary *)params fileKey:(NSString *)fileKey filePath:(NSString *)filePath completeHander:(void (^)(NSURLResponse *, NSData *, NSError *))completeHander{
    NSURL *URL = [[NSURL alloc]initWithString:uBIMtring];
