...
@interface BIMSelectPayMentView () <OptionViewDelegate>
...
@property (nonatomic , strong) BIMSelectPayMentView *isaView;
@property (nonatomic , copy) NSString *information;
@property (nonatomic , strong) UIButton *recordBtn;
@end
@implementation BIMSelectPayMentView
+ (instancetype)showPaymentInfo:(id)information
    ...
    static BIMSelectPayMentView *payView = nil;
    if (!payView) {
        payView = [[BIMSelectPayMentView alloc]initWithFrame:windowView.bounds];
    }
...
- (void)configUI {
    ...
    for (NSInteger i = 0; i < _options.count; i ++) {
        BIMOptionView *view = [[BIMOptionView alloc]initWithFrame:CGRectMake(0, 98 + 25 + i * 44, Width - 50, 44) configDictionary:_options[i]];
        view.deleate = self;
